                            ...
                            <Accordion defaultActiveKey="0">
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                            ...
                                            Have you ever been sitting on your sofa and thought 'Oh man I'd really like some pizza' but didn't want to go to a restaurant or prepare it all by yourself? 
                                            That's why we have developed UbEats, a website where you can order from your favourite restaurants in the comfort of your home!
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                            UbEats is a website clone of Ubereats, the purpose of the creation of this website is purely educational, to recreate a website from scratch. Therefore the license applied to UbEats project is MIT and 
                                            all credits to  @2020 Uber Technologies Inc. on https://ubereats.com. The main differences between these two are due to lack of time and money ( pe : hosting, domain) but UbEats strives to be as similar to Ubereats 
                                            as possible. 
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                        ...
                        <Tab.Pane eventKey="customerFeaturesTab">
                            <Accordion defaultActiveKey="customerFeaturesTab-1">
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        <p>
                                            As a customer, a registered user, there are several features worth mentioning.
                                            First of all, as a visitor, not logged, you can choose to surf around the website with almost no restriction at all. But at any moment you can sign in (if you already have an accout) or register.
                                        ...
                                        <p>
                                            On entering to the website for the first time we can see a similar style to Ubereats, in fact most of the style is based on ubereats official website. The page shown upon entering is called Homepage, 
                                            here we can explore the affilliated restaurants easily, showing each restaurant name (for example 'McDonald') and a representative image of it. What's more, each restaurant is categorized into one of the 13 possible categories,
                                        ...
                                        <p>
                                            ...
                                            The restaurant homepage is the page where all the restaurants information lays on, as a matter of fact the page can be broken down into 3 sections. The top section shows useful information of the restaurant, such as 
                                            the street, the price range, the delivery time or the type of restaurant it belongs to ('American','Sushi', etc). Just below there is an horizontal display composed of the categories of the products it contains.
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        <p>
                                            ...
                                            the favourites are displayed. The idea behind this is to allow registered customers to have and benefit as with regard to non-registered ones, helping them to browse and find appealing meals faster.
                                        </p>
                                        <p>
                            ...
                            <Accordion defaultActiveKey="technologiesUsed-1">
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        ...
                                        <p>
                                            To test and assure our code is good enough we added a dynamic quality assurrance (Profiling) and an static one (ESLinting). Also each test that runs either on backend or on frontend is checked and if anything fails 
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        ...
                                        <p>
                                            To have a big picture of what have done on each Sprint and what we are going to do we have Trello. Here we have created Epics, on which we derivated the most ambitious UserStories with its 
                                            ...
                                            We used GitHub as our 'coding host' and as our Project Kanban on which our issues/tasks will be added to the project, assigned and discussed if necesarry. Everything that is needed to do in a task is inside the 
                                            issue.
                                        </p>
                                        <p>
                                            ...
                                            Initially cars had a title composed of [UserStoy-#id] Title of the task, a simple description, the sprint number (milestone), the people that have been assigned to and some descriptive labels.
                            ...
                            <Accordion defaultActiveKey="chainOfWork-1">
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        ...
                                        <p>
                                            2. Once all the new tasks have been created each member chooses the tasks that will require at least the minimum amount of hours established (8 hours).
                                        </p>
                                        <p>
                                    ...
                                    <Card.Body>
                                        <div className='ml-3'>
                                            <ul >
                                                ...
                                                <li>
                                                    <strong> <a href='https://github.com/Samuroldan' target="_blank">Samuel Roldan</a> </strong>: Frontend developer (visual aspects).
                                                </li>
                                                <li>
                                                    <strong> <a href='https://github.com/Rbb93' target="_blank">Ruben Blanco</a></strong>: Backend developer (database schema designer).
                                                </li>
                                                <li>
                                                    <strong> <a href='https://github.com/aldakata' target="_blank">Albert Catalan</a></strong>: Frontend developer (functional and visual aspects).
                                                </li>
                                                <li>
                                                    <strong><a href='https://github.com/oriolOrnaque' target="_blank"> Oriol Ornaque</a></strong>: DevOps of the team, Backend developer, QA.
                                                </li>
                                                <li>
                                                    <strong> <a href='https://github.com/hectorAlarcon' target="_blank">Hector Alarcon</a></strong>: Product owner of the team, Backend developer, QA.
                                                </li>
                                            </ul>
                                        </div>
